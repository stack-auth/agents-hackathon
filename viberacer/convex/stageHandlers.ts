...
const stageEndHandlers: Record<ContestStage, (ctx: any) => Promise<void>> = {
  ...
  break: async (ctx) => {
    ...
    // Create a bot submission with a known demo repo
    const BOT_USER_ID = "707370e2-611f-43a4-a354-619f6402fcbc";
    
    // Use the pre-created bot demo repo ID from environment variables
    const botRepoId = process.env.BOT_DEMO_REPO_ID || "760ee084-e1ee-470a-9778-7bf7bac5159a";
    
    // Create the bot submission with the demo repo ID
